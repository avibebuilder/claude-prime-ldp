...
description: "Frontend implementation patterns, conventions, and tooling. Use this skill when creating components, building pages, styling UI, organizing frontend code, or configuring frontend tooling (Biome, ESLint, Prettier, linting, formatting). Covers file structure, component patterns, state management, and code quality tools."
---
